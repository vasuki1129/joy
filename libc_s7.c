...
/* -------- posix_fadvise -------- */
static s7_pointer s7__posix_fadvise(s7_scheme *sc, s7_pointer args)
{
  s7_pointer p, arg;
  int s7__posix_fadvise_0;
  int s7__posix_fadvise_1;
  int s7__posix_fadvise_2;
  int s7__posix_fadvise_3;
  p = args;
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__posix_fadvise_0 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'posix_fadvise)", 23), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__posix_fadvise_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'posix_fadvise)", 23), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__posix_fadvise_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'posix_fadvise)", 23), 3, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__posix_fadvise_3 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'posix_fadvise)", 23), 4, arg, integer_string));
  return(s7_make_integer(sc, (s7_int)posix_fadvise(s7__posix_fadvise_0, s7__posix_fadvise_1, s7__posix_fadvise_2, s7__posix_fadvise_3)));
}


/* -------- posix_fallocate -------- */
static s7_pointer s7__posix_fallocate(s7_scheme *sc, s7_pointer args)
{
  s7_pointer p, arg;
  int s7__posix_fallocate_0;
  int s7__posix_fallocate_1;
  int s7__posix_fallocate_2;
  p = args;
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__posix_fallocate_0 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'posix_fallocate)", 25), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__posix_fallocate_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'posix_fallocate)", 25), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__posix_fallocate_2 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'posix_fallocate)", 25), 3, arg, integer_string));
  return(s7_make_integer(sc, (s7_int)posix_fallocate(s7__posix_fallocate_0, s7__posix_fallocate_1, s7__posix_fallocate_2)));
}
...
/* -------- sigwaitinfo -------- */
static s7_pointer s7__sigwaitinfo(s7_scheme *sc, s7_pointer args)
{
  s7_pointer p, arg;
  sigset_t* s7__sigwaitinfo_0;
  siginfo_t* s7__sigwaitinfo_1;
  p = args;
  arg = s7_car(p);
  s7__sigwaitinfo_0 = (sigset_t*)s7_c_pointer_with_type(sc, arg, sigset_t__symbol, __func__, 1);
  p = s7_cdr(p);
  arg = s7_car(p);
  s7__sigwaitinfo_1 = (siginfo_t*)s7_c_pointer_with_type(sc, arg, siginfo_t__symbol, __func__, 2);
  return(s7_make_integer(sc, (s7_int)sigwaitinfo(s7__sigwaitinfo_0, s7__sigwaitinfo_1)));
}


/* -------- waitid -------- */
static s7_pointer s7__waitid(s7_scheme *sc, s7_pointer args)
{
  s7_pointer p, arg;
  idtype_t s7__waitid_0;
  int s7__waitid_1;
  siginfo_t* s7__waitid_2;
  int s7__waitid_3;
  p = args;
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__waitid_0 = (idtype_t)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'waitid)", 16), 1, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__waitid_1 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'waitid)", 16), 2, arg, integer_string));
  p = s7_cdr(p);
  arg = s7_car(p);
  s7__waitid_2 = (siginfo_t*)s7_c_pointer_with_type(sc, arg, siginfo_t__symbol, __func__, 3);
  p = s7_cdr(p);
  arg = s7_car(p);
  if (s7_is_integer(arg))
    s7__waitid_3 = (int)s7_integer(arg);
  else return(s7_wrong_type_error(sc, s7_make_string_wrapper_with_length(sc, "(*libc* 'waitid)", 16), 4, arg, integer_string));
  return(s7_make_integer(sc, (s7_int)waitid(s7__waitid_0, s7__waitid_1, s7__waitid_2, s7__waitid_3)));
}
...
{
  s7_pointer cur_env;
  s7_pointer pcl_t, pl_tx, pl_ts, pl_ti, pl_txs, pcl_s, pl_sx, pl_st, pl_si, pl_sis, pl_ssi, pl_sssi, pl_ssix, pl_sisi, pcl_di, pl_ds, pcl_x, pl_xs, pcl_xi, pl_xi, pl_xt, pcl_xs, pl_xxi, pcl_xxi, pl_xis, pl_xxxi, pl_xssx, pcl_i, pl_ix, pl_it, pcl_is, pl_is, pcl_ix, pcl_iix, pcl_isi, pl_ixi, pl_isi, pl_iix, pl_isx, pcl_ixi, pl_isxi, pl_iisi, pcl_iixi, pl_iixi, pl_issi, pl_ixxi, pcl_ixsi, pl_iiixi, pl_ixiix, pl_iixiixi;
  {
  ...
  siginfo_t__symbol = s7_make_symbol(sc, "siginfo_t*");
  ...
  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "waitid"),
            ffunc = s7_make_typed_function_with_environment(sc, "waitid", s7__waitid, 4, 0, false, "int waitid((idtype_t int) int siginfo_t* int)", pl_iiixi, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "sigwaitinfo"),
            ffunc = s7_make_typed_function_with_environment(sc, "sigwaitinfo", s7__sigwaitinfo, 2, 0, false, "int sigwaitinfo(sigset_t* siginfo_t*)", pcl_ix, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);
  ...
  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "WIFSTOPPED"),
            ffunc = s7_make_typed_function_with_environment(sc, "WIFSTOPPED", g_WIFSTOPPED, 1, 0, false, "WIFSTOPPED", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "WIFSIGNALED"),
            ffunc = s7_make_typed_function_with_environment(sc, "WIFSIGNALED", g_WIFSIGNALED, 1, 0, false, "WIFSIGNALED", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "WIFEXITED"),
            ffunc = s7_make_typed_function_with_environment(sc, "WIFEXITED", g_WIFEXITED, 1, 0, false, "WIFEXITED", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "WSTOPSIG"),
            ffunc = s7_make_typed_function_with_environment(sc, "WSTOPSIG", g_WSTOPSIG, 1, 0, false, "WSTOPSIG", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "WTERMSIG"),
            ffunc = s7_make_typed_function_with_environment(sc, "WTERMSIG", g_WTERMSIG, 1, 0, false, "WTERMSIG", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "WEXITSTATUS"),
            ffunc = s7_make_typed_function_with_environment(sc, "WEXITSTATUS", g_WEXITSTATUS, 1, 0, false, "WEXITSTATUS", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);
  ...
  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_addr"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_addr", g_siginfo_si_addr, 1, 0, false, "siginfo.si_addr", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_ptr"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_ptr", g_siginfo_si_ptr, 1, 0, false, "siginfo.si_ptr", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_fd"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_fd", g_siginfo_si_fd, 1, 0, false, "siginfo.si_fd", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_band"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_band", g_siginfo_si_band, 1, 0, false, "siginfo.si_band", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_timerid"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_timerid", g_siginfo_si_timerid, 1, 0, false, "siginfo.si_timerid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_overrun"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_overrun", g_siginfo_si_overrun, 1, 0, false, "siginfo.si_overrun", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_int"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_int", g_siginfo_si_int, 1, 0, false, "siginfo.si_int", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_value"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_value", g_siginfo_si_value, 1, 0, false, "siginfo.si_value", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_stime"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_stime", g_siginfo_si_stime, 1, 0, false, "siginfo.si_stime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_utime"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_utime", g_siginfo_si_utime, 1, 0, false, "siginfo.si_utime", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_status"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_status", g_siginfo_si_status, 1, 0, false, "siginfo.si_status", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_uid"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_uid", g_siginfo_si_uid, 1, 0, false, "siginfo.si_uid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_pid"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_pid", g_siginfo_si_pid, 1, 0, false, "siginfo.si_pid", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_code"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_code", g_siginfo_si_code, 1, 0, false, "siginfo.si_code", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_errno"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_errno", g_siginfo_si_errno, 1, 0, false, "siginfo.si_errno", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.si_signo"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.si_signo", g_siginfo_si_signo, 1, 0, false, "siginfo.si_signo", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "siginfo.make"),
            ffunc = s7_make_typed_function_with_environment(sc, "siginfo.make", g_siginfo_make, 0, 0, false, "siginfo.make", NULL, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);
  ...
  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "posix_fallocate"),
            ffunc = s7_make_typed_function_with_environment(sc, "posix_fallocate", s7__posix_fallocate, 3, 0, false, "int posix_fallocate(int int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);

  s7_define(sc, cur_env,
            fsym = s7_make_symbol(sc, "posix_fadvise"),
            ffunc = s7_make_typed_function_with_environment(sc, "posix_fadvise", s7__posix_fadvise, 4, 0, false, "int posix_fadvise(int int int int)", pcl_i, cur_env));
  s7_symbol_set_initial_value(sc, fsym, ffunc);
